...
def main():
    ...
    subgs = torch.load('/home/ubuntu/code/arxiv-shadowkhop-[5,10,15].pt')
    ...
    # feats = np.fromfile('/home/ubuntu/mag/full.npy', dtype="float16").reshape(num_nodes, num_features)
    ...
    for e in range(args.epochs):
        ...
        for graph in subgs['train']:
            graph.ndata['feat'] = torch.from_numpy(feats[graph.ndata['_ID']])
