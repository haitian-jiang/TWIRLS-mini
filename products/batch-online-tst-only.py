...
def parse_args():
    ...
    parser.add_argument('--subg_percent', type=float, default=1)
    # parser.add_argument('--model', type=str, default=f'50-percent.pt')
...
def main():
    ...
    model = torch.load(f'./{int(100*args.subg_percent)}-percent.pt')
    # # --- init model --- #
    ...
    # early_stop_cnt = 0
    # train_samples = random.sample(range(197), int(197 * args.subg_percent))
    # for e in range(args.epochs):
    #     # --- train --- #
    #     tot_loss = 0
    #     for i in tqdm(train_samples):
    #     # for i in trange(int(197 * args.subg_percent)):
    ...
    #         early_stop_cnt = 0
    #         torch.save(best_model, f'./{int(100*args.subg_percent)}-percent.pt')
    #     else:
    #         early_stop_cnt += 1
